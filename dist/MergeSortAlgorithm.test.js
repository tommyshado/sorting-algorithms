...
function MergeSortAlgorithm(arr) {
    ...
    for (let j = middle + 1; j < arr.length - 1; j++) {
        right.push(arr[j]);
    }
...
;
// create a function called Merge that takes in three unsorted arrays
function Merge(leftArray, rightArray, actualArray) {
    console.log("****LLLL*****", leftArray);
    console.log("***RRRRR***", rightArray);
